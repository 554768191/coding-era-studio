package com.codingera.module.fileUpload.controll;
...
import com.codingera.module.fileUpload.model.AttachmentView;
import com.codingera.module.fileUpload.service.AttachmentManager;
...
public class FileUploadController {
	...
	public ActionResult uploadImage(@RequestParam("file") MultipartFile file) {
		try {
			Attachment uploadedFile = attachmentManager.addAttachment(file.getOriginalFilename(), file.getBytes());
