package com.codingera.common.security;
...
public class CEAuthenticationEntryPoint extends LoginUrlAuthenticationEntryPoint {  
  
    public CEAuthenticationEntryPoint(String loginFormUrl) {
		super(loginFormUrl);
		// TODO Auto-generated constructor stub
	}

	private static final Log logger = LogFactory.getLog(CEAuthenticationEntryPoint.class);  
        ...
        if (url.indexOf("ajax") == -1) {  
            ...
            try {  
               // JsonData jsonData = new JsonData(2, null);  
                objectMapper.writeValue(jsonGenerator, "success");  
