...
//@SpringApplicationConfiguration(CodingeraBootApplication.class)
...
public class WebApplicationTests {
	...
	public void testHome() throws Exception {
		...
		ResponseEntity<String> entity = new TestRestTemplate().exchange("http://localhost:" + this.port+"/11111"
				, HttpMethod.GET, new HttpEntity<Void>(headers), String.class);
		System.out.println("测试不存在的url:" + entity.getBody());
		ResponseEntity<String> entity2 = new TestRestTemplate().exchange("http://localhost:" + this.port+"/api/article/list"
				, HttpMethod.GET, new HttpEntity<Void>(headers), String.class);
		System.out.println("测试api/article/list:" + entity2.getBody());
		ResponseEntity<String> entity3 = new TestRestTemplate().exchange("http://localhost:" + this.port+"/oauth/authorize"
				, HttpMethod.GET, new HttpEntity<Void>(headers), String.class);
		System.out.println("测试api/article/list:" + entity3.getBody().contains("<!DOCTYPE html>"));
		assertThat(entity3.getBody().contains("<!DOCTYPE html>")).isEqualTo(true);
	}
