 ...
 * MockMvc test 
 * 
 * Testing with MockMvc is also possible, but needs a little helper
 * class to get a RequestPostProcessor that sets the Authorization: Bearer
 * <token> header on requests:
 * 
...
public class OAuthHelper {
	...
	OAuth2AccessToken createAccessToken(final String clientId) {
		...
		User userPrincipal = null;// new User("user", "", true, true, true, true, authorities);
